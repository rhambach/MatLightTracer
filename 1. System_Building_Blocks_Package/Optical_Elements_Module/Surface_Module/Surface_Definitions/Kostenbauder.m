function [ returnDataStruct] = Kostenbauder(returnFlag,surfaceParameters,inputDataStruct)
    ...
    switch returnFlag
        ...
        case 5 % Paraxial ray trace results
            ...
            ABCD = [A,B;C,D];
            % Check for validity of the matrix
            detM = A*D - B*C;
            if ~(detM == indexBefore/indexAfter)
                disp(['Error: The ABCD parameters of the Kostenbauder matrix',...
                    ' surface are not valid. Do not fulfill the AD-BC = n1/n2',...
                    'So the default unity matrix is used.']);
                A = 1; B = 0; C = 0; D = 1;
            end
        ...
        case 6 % Real Ray trace new direction
            ...
            thicknessAfter = (1)./((indexBefore./thicknessBefore + 1./focalLength).*indexAfter);
            ...
            TIR = zeros(1,size(exitRayDirection,2));
        ...
        case 9 % Exit position
            rayDirection = inputDataStruct.RayDirection;
            rayPosition = inputDataStruct.RayIntersectionPoint;
            wavlenInM = inputDataStruct.WavelengthInM;
            refWavlenInM = inputDataStruct.ReferenceWavelengthInM;
            ...
            returnDataStruct.LocalExitRayPosition = exitRayPosition;
