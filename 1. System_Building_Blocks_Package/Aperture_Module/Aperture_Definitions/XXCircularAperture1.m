function [ returnData1, returnData2, returnData3  ] = CircularAperture...
        ( returnFlag,apertureParameters,xyVector )
    %CircularAperture  Defn of aperture with circular shape.
    % Inputs:
    %   (returnFlag,apertureParameters,xyVector )
    ...
    if nargin == 0
        disp(['Error: The function CircularAperture() needs either one or three arguments',...
    ...
    elseif nargin == 1
        if returnFlag == 1
            ...
            disp(['Error: The function CircularAperture() needs three arguments',...
                'return type, apertureParameters, and xyVector.']);
            returnData1 = NaN;
            returnData2 = NaN;
            returnData3 = NaN;
