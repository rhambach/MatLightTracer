function [ generallyAstigmaticGaussianBeamSet ] = ...
        ...
        gaussianBeamRayBundleArray,totalPathLengths )
    ...
    nArray = length(gaussianBeamRayBundleArray);
    for kk = 1:nArray
