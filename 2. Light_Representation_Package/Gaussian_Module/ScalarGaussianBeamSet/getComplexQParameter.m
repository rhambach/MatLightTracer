function [ qx,qy ] = getComplexQParameter( gaussianBeamSet )
    ...
    qx = 1./((1./radiusOfCurvatureInX)-...
        1i*([gaussianBeamSet.CentralRay.Wavelength]./(pi*(spotRadiusInX).^2)));
    qy = 1./((1./radiusOfCurvatureInY)-...
        1i*([gaussianBeamSet.CentralRay.Wavelength]./(pi*(spotRadiusInY).^2)));
end
