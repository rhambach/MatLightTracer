function [ waistAndDivergenceRaysAtObjectSurface ] = getWaistAndDivergenceRaysAtObjectSurface...
    ...
    [waistRayXAtSurface2,waistRayYAtSurface2] = getWaistRays(gaussianBeamSet);
    [divergenceRayXAtSurface2,divergenceRayYAtSurface2] = getDivergenceRays(gaussianBeamSet);
    ...
    centralRay = [gaussianBeamSet.CentralRay];
    ...
    waistRayXAtSurface1Position = mat2cell(([waistRayXAtSurface2.Position] + ...
        repmat(distToObjectForWaistRayInX,3,1).*centerRayDirection),[3],[ones(1,length(gaussianBeamSet))]);
    waistRayYAtSurface1Position = mat2cell(([waistRayYAtSurface2.Position] + ...
        repmat(distToObjectForWaistRayInY,3,1).*centerRayDirection),[3],[ones(1,length(gaussianBeamSet))]);
