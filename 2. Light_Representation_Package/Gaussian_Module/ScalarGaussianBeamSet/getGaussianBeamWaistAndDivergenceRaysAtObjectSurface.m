function [ waistAndDivergenceRaysAtObjectSurface ] = getGaussianBeamWaistAndDivergenceRaysAtObjectSurface...
    ...
    %getGaussianBeamWaistAndDivergenceRays returns the 5 rays used to trace the gaussian beam
    ...
    [waistRayXAtSurface2,waistRayYAtSurface2] = getGaussianBeamWaistRays(gaussianBeamSet);
    [divergenceRayXAtSurface2,divergenceRayYAtSurface2] = getGaussianBeamDivergenceRays(gaussianBeamSet);
