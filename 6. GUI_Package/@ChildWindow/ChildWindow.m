classdef ChildWindow < handle
    ...
    methods
        ...
        function NewChild = ChildWindow(myName,myParent)
            ...
            % Define Configuration selection popup menu and add to Setting Tab
            NewChild.ChildHandles.lblMulticonfigurationIndex = uicontrol( ...
                NewChild.ChildHandles.SettingTab,...
                'Units', 'Normalized', ...
                'Tag', 'lblMulticonfigurationIndex', ...
                'Style', 'text', ...
                'HorizontalAlignment','Left',...
                'FontSize',fontSize,'FontName', 'FixedWidth',...
                'Position', [0.05, 0.02, 0.30, 0.05],...
                'String', 'Multi-Configuration Index ');
            
            
            nConfiguration = length(myParent.ParentHandles.OpticalSystem);
            AllMulticonfigurationIndices = [num2cell([1:nConfiguration]),'All'];
            NewChild.ChildHandles.popMulticonfigurationIndex = uicontrol( ...
                NewChild.ChildHandles.SettingTab,...
                'Units', 'Normalized', ...
                'Tag', 'popMulticonfigurationIndex', ...
                'FontSize',fontSize,'FontName', 'FixedWidth',...
                'Style', 'popupmenu', ...
                'BackgroundColor', [1 1 1], ...
                'Position', [0.35, 0.03, 0.1, 0.05],...
                'String', AllMulticonfigurationIndices,...
                'Value',1);
