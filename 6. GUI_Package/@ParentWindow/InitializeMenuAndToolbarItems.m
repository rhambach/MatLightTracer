function InitializeMenuAndToolbarItems(parentWindow)
    ...
    aodHandles.menuFFTFocusedPulse = uimenu( ...
        ...
        %-----------------------------------------------------------------------
    aodHandles.menuMulticonfiguration = uimenu( ...
        'Parent', aodHandles.FigureHandle, ...
        'Tag', 'menuMulticonfiguration', ...
        'Label', 'Multi-Configuration', ...
        'Checked', 'off', ...
        'visible', 'off', ...
        'Callback', {@menuMulticonfiguration_Callback,parentWindow});
    
    aodHandles.menuAddConfiguration = uimenu( ...
        'Parent', aodHandles.menuMulticonfiguration, ...
        'Tag', 'menuAddConfiguration', ...
        'Visible', 'on', ...
        'Label', 'Add New', ...
        'Checked', 'off', ...
        'Callback', {@menuAddConfiguration_Callback,parentWindow});
    
    aodHandles.menuSelectConfiguration = uimenu( ...
        'Parent', aodHandles.menuMulticonfiguration, ...
        'Tag', 'menuSelectConfiguration', ...
        'Visible', 'on', ...
        'Label', 'Select', ...
        'Checked', 'off', ...
        'Callback', {@menuSelectConfiguration_Callback,parentWindow});
    aodHandles.menuSelectConfigurationList(1) = uimenu( ...
        'Parent', aodHandles.menuSelectConfiguration, ...
        'Tag', 'menuSelectConfigurationList', ...
        'Label', '1 : Unnamed ', ...
        'Separator','off',...
        'Checked', 'off');
    
    aodHandles.menuRemoveConfiguration = uimenu( ...
        'Parent', aodHandles.menuMulticonfiguration, ...
        'Tag', 'menuRemoveConfiguration', ...
        'Label', 'Remove', ...
        'Checked', 'off', ...
        'Callback', {@menuRemoveConfiguration_Callback,parentWindow});
    aodHandles.menuRemoveConfigurationList(1) = uimenu( ...
        'Parent', aodHandles.menuRemoveConfiguration, ...
        'Tag', 'menuRemoveConfigurationList', ...
        'Label', '1 : Unnamed ', ...
        'Separator','off',...
        'Checked', 'off');    
    %-----------------------------------------------------------------------
    ...
    aodHandles.menuUserManualAndProgrammingRefernce = uimenu( ...
        'Parent', aodHandles.menuHelp, ...
        'Tag', 'menuUserManual', ...
        'Label', 'User Manual And Programming Refernce', ...
        'Checked', 'off', ...
        'Callback', {@menuUserManualAndProgrammingRefernce_Callback,parentWindow});
...
% ---------------------------------------------------------------------
function menuUserManualAndProgrammingRefernce_Callback(~,~,parentWindow)
    winopen(which('MatLightTracer Version 1.0 Reference.chm'))
end
...
function menuMulticonfiguration_Callback(~,~,parentWindow)
    
end
function menuSelectConfiguration_Callback(~,~,parentWindow)
    
end
function menuAddConfiguration_Callback(~,~,parentWindow)
    aodHandles = parentWindow.ParentHandles;
    ...
    allOpticalSystems(nConfiguration+1) = allOpticalSystems(currentConfiguration);
    allOpticalSystems(nConfiguration+1).LensName = 'Unnamed Config';
    
    aodHandles.OpticalSystem = allOpticalSystems;
    parentWindow.ParentHandles = aodHandles;
    updateMulticonfigurationMenu(parentWindow);
end
function menuRemoveConfiguration_Callback(~,~,parentWindow)
...
function menuSourceCodeExplorer_Callback(~,~,parentWindow)
    ...
    choice = questdlg('The source code explorer has not been updated. Do you want to see the source codes for the older version of the toolbox?', ...
        'Unupdated Feature', ...
        'Yes','No','Yes');
    % Handle response
    switch choice
