function [ returnDataStruct] = RadialPolarization(returnFlag,polarizationParameters,inputDataStruct)
    % RadialPolarization A user defined function for radially polarized
    ...
    if nargin < 1
        disp(['Error: The function RadialPolarization() needs atleast one argument',...
            'the return type.']);
    ...
    if nargin < 2
        ...
        elseif returnFlag == 2
            ...
            retF = 1;
            returnData = RadialPolarization(retF);
            polarizationParameters = returnData.DefaultUniqueParametersStruct;
            
            inputDataStruct = struct();
        else
            disp(['Error: The function RadialPolarization() needs all three ',...
