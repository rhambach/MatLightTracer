function [ surfaceNormals ] = getAllSurfaceSurfaceNormal( allSurfaceRayTraceResult,...
    ...
    %   ray
    % Output:
    %   surfaceNormals: is (3 X nSurface X nPupilPointsRequested X nFieldRequested X nWavRequested)
    
    if nargin == 0
        disp(['Error: The function  getAllSurfaceSurfaceNormal requires ',...
    ...
    requestedResultFieldName = 'SurfaceNormal';
    requestedFieldFirstDim = 3;
    surfaceNormals = getRayTraceResultFieldForAllSurfaces( ...
