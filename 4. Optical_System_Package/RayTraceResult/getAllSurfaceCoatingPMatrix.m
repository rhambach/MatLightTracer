function [ coatingPMatrixs ] = getAllSurfaceCoatingPMatrix( allSurfaceRayTraceResult,...
        rayPupilIndices,rayFieldIndices,rayWavelengthIndices)
    %getAllSurfaceCoatingPMatrix: Returns the Coating Polarization Matrix of a specific
    ...
    %   ray
    % Output:
    %   coatingPMatrixs: is (3 X 3 X nSurface X nPupilPointsRequested X nFieldRequested X nWavRequested)
    
    if nargin == 0
        disp(['Error: The function  getAllSurfaceCoatingPMatrix requires ',...
    ...
    requestedResultFieldName = 'CoatingPMatrix';
    requestedFieldFirstDim = [3,3];
    coatingPMatrixs = getRayTraceResultFieldForAllSurfaces( ...
