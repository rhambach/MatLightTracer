function [ coatingQMatrixs ] = getAllSurfaceCoatingQMatrix( allSurfaceRayTraceResult,...
    ...
    %   ray
    % Output:
    %   coatingQMatrixs: is (3 X 3 X nSurface X nPupilPointsRequested X nFieldRequested X nWavRequested)
    
    if nargin == 0
        disp(['Error: The function  getAllSurfaceCoatingQMatrix requires ',...
    ...
    requestedResultFieldName = 'CoatingQMatrix';
    requestedFieldFirstDim = [3,3];
    coatingQMatrixs = getRayTraceResultFieldForAllSurfaces( ...
