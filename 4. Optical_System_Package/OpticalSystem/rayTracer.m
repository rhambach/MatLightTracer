function rayTracerResultReshaped = rayTracer(optSystem, objectRayBundle,rayTraceOptionStruct,endSurface,nRayPupil,nField,nWav)
    ...
    wavlenInWavlenUnit = wavlenInM/wavelengthUnitFactor;
    ...
    %% Convert the position and length and wavelengths to SI units (meter)
    RayIntersectionPointInM = RayIntersectionPoint*lensUnitFactor;
    ExitRayPositionInM = ExitRayPosition*lensUnitFactor;
    WavelengthInM = wavlenInWavlenUnit*wavelengthUnitFactor;
    GeometricalPathLengthInM = GeometricalPathLength*lensUnitFactor;
    AdditionalPathLengthInM = AdditionalPathLength*lensUnitFactor;
    OpticalPathLengthInM = OpticalPathLength*lensUnitFactor;
    GroupPathLengthInM = GroupPathLength*lensUnitFactor;
    TotalPathLengthInM = TotalPathLength*lensUnitFactor;
    TotalOpticalPathLengthInM = TotalOpticalPathLength*lensUnitFactor;
    TotalGroupPathLengthInM = TotalGroupPathLength*lensUnitFactor;
    if considerPolarization
        if recordIntermediateResults
            multipleRayTracerResultAll(startNonDummyIndex,:) = RayTraceResult(nRayPupil,nField,nWav,...
                RayIntersectionPointInM,ExitRayPositionInM,SurfaceNormal,...
                IncidentRayDirection,ExitRayDirection,WavelengthInM,...
                NoIntersectionPoint,OutOfAperture,TotalInternalReflection,GeometricalPathLengthInM,AdditionalPathLengthInM,OpticalPathLengthInM,...
                GroupPathLengthInM,TotalPathLengthInM,TotalOpticalPathLengthInM,TotalGroupPathLengthInM,...
    ...
    %                 IncidentRayDirection,ExitRayDirection,wavlenInWavlenUnit,NoIntersectionPoint,OutOfAperture,TotalInternalReflection,GeometricalPathLength,AdditionalPathLength,OpticalPathLength,...
    ...
    for surfaceIndex = startNonDummyIndex+1:1:endNonDummyIndex
        ...
        %% Convert the position and length and wavelengths to SI units (meter)
        GlobalRayIntersectionPointInM = GlobalRayIntersectionPoint*lensUnitFactor;
        GlobalExitRayPositionInM = GlobalExitRayPosition*lensUnitFactor;
        WavelengthInM = wavlenInWavlenUnit*wavelengthUnitFactor;
        GeometricalPathLengthInM = GeometricalPathLength*lensUnitFactor;
        AdditionalPathLengthInM = AdditionalPathLength*lensUnitFactor;
        OpticalPathLengthInM = OpticalPathLength*lensUnitFactor;
        ...
        if recordIntermediateResults
            if considerPolarization
                multipleRayTracerResultAll(surfaceIndex,:) = RayTraceResult(nRayPupil,nField,nWav,...
                    GlobalRayIntersectionPointInM,GlobalExitRayPositionInM,GlobalSurfaceNormal,...
                    GlobalIncidentRayDirection,GlobalExitRayDirection,WavelengthInM,...
                    NoIntersectionPoint,OutOfAperture,TIR,GeometricalPathLengthInM,AdditionalPathLengthInM,OpticalPathLengthInM,...
                    GroupPathLengthInM,TotalPathLengthInM,TotalOpticalPathLengthInM,TotalGroupPathLengthInM,...
                    RefractiveIndex,RefractiveIndexFirstDerivative,RefractiveIndexSecondDerivative,...
                    GroupRefractiveIndex,CoatingJonesMatrix,CoatingPMatrix,CoatingQMatrix,TotalPMatrix,TotalQMatrix);
            else
        ...
        %                 multipleRayTracerResultAll(surfaceIndex,:) = RayTraceResult(nRayPupil,nField,nWav,...
        %                     GlobalRayIntersectionPoint,GlobalExitRayPosition,GlobalSurfaceNormal,...
        %                     GlobalIncidentRayDirection,GlobalExitRayDirection,wavlenInWavlenUnit,...
        ...
        %                 multipleRayTracerResultAll(surfaceIndex,:) = RayTraceResult(nRayPupil,nField,nWav,...
        %                     GlobalRayIntersectionPoint,GlobalExitRayPosition,GlobalSurfaceNormal,...
        %                     GlobalIncidentRayDirection,GlobalExitRayDirection,wavlenInWavlenUnit,NoIntersectionPoint,...
        ...
        %                         GlobalExitRayDirection,wavlenInWavlenUnit,NoIntersectionPoint,OutOfAperture,TIR,GeometricalPathLength,AdditionalPathLength,OpticalPathLength,...
        %                         GroupPathLength,TotalPathLength,TotalOpticalPathLength,TotalGroupPathLength,...
        %                         RefractiveIndex,RefractiveIndexFirstDerivative,RefractiveIndexSecondDerivative,...
        %                         GroupRefractiveIndex,CoatingJonesMatrix,CoatingPMatrix,CoatingQMatrix,TotalPMatrix,TotalQMatrix);
        %                 else
